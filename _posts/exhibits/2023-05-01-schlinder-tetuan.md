...
{% picture jpt-webp  "projects/tetuan2.jpg" 2:1 --link {{ page.external_link }} %}
</div>
...
<div style="max-width: 90%; margin: 0 auto;">
{% picture jpt-webp  "projects/schindler3.jpg" 2:1 --link {{ page.external_link }} %}
</div>
...
<div style="max-width: 90%; margin: 0 auto;">
{% picture jpt-webp  "projects/schlinderor.jpg" 2:1 --link {{ page.external_link }} %}
</div>
